...
import com.enviro.assessment.grad001.elviskgomo.repo.WasteCategoryRepo;
...
public class WasteCategoryService {
    ...
    private final WasteCategoryRepo repo;

    public WasteCategoryService(WasteCategoryRepo repo){
        this.repo = repo;
    }
